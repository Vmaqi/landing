...
anubis.forEach((Anubis77, i) => {
  const banim = gsap.fromTo(
    Anubis77,
    { autoAlpha: 0, y: 100 },
    { duration: 1, delay: 0.15, autoAlpha: 1, y: 0 }
  );
...
intro.forEach((Anubisintro, i) => {
  const aanim = gsap.fromTo(
    Anubisintro,
    { autoAlpha: 0, y: 200 },
    { duration: 2, delay: 0.65, autoAlpha: 1, y: 0 }
  );
  ScrollTrigger.create({
    trigger: Anubisintro,
    animation: aanim,
...
logo.forEach((parallax, i) => {
  const zanim = gsap.fromTo(
    parallax,
    { autoAlpha: 0, y: 200 },
    { duration: 2, delay: 0.25, autoAlpha: 1, y: 0 }
  );
  ScrollTrigger.create({
    trigger: intro,
    animation: zanim,
